    ...
    return (
        <div className="fixed top-0 left-0 right-0 h-[60%] z-50 pt-12 px-4 text-white">
            ...
            <div className="relative bg-primary p-4 h-full rounded-xl flex flex-col justify-around items-center text-center">
                ...
                <p className="text-lg">Для лучшего использования приложения, добавьте приложение на &quot;Домашний экран&quot;</p>
                ...
                <button className="border-2 p-1" onClick={doNotShowAgain}>Не показывать снова</button>
            </div>
        </div>
    )
}